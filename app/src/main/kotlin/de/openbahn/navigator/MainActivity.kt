...
import de.openbahn.navigator.ui.board.BoardScreen
            ...
            OpenBahnTheme {
                ...
                Scaffold(
                        ...
                        if (currentRoute != Routes.FILTERS) {
                            NavigationBar {
                                listOf(
                                    ...
                                    Triple(Routes.BOARD, Icons.Default.DirectionsTransit, R.string.nav_board),
                    ...
                    NavHost(
                        ...
                        composable(Routes.BOARD) { BoardScreen() }
